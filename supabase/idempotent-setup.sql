-- ============================================
-- SCRIPT IDEMPOTENT - TenisMatch Phone-Only
-- ============================================
...
-- Supprimer les politiques de manière idempotente
DO $$
DECLARE
...
BEGIN
    ...
    LOOP
        BEGIN
            EXECUTE format('DROP POLICY IF EXISTS %I ON public.%I', policy_record.polname, c.relname);
...
-- ============================================
-- SUPPRESSION DES TABLES, VUES ET FONCTIONS
-- ============================================
...
-- Table users (authentification par téléphone)
...
-- ============================================
-- FIN DU SCRIPT IDEMPOTENT
-- ============================================
-- Ce script peut être exécuté plusieurs fois sans erreur
-- Votre base TenisMatch est maintenant prête !
