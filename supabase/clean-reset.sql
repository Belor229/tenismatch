-- ============================================
-- SCRIPT DE NETTOYAGE COMPLET - TenisMatch
-- ============================================
-- Ce script supprime TOUTES les tables, vues, fonctions et politiques
-- Puis recrée une base de données propre
...
ALTER TABLE IF EXISTS public.victories DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.events DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.event_participants DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.notifications DISABLE ROW LEVEL SECURITY;

-- Supprimer toutes les politiques
DROP POLICY IF EXISTS "Users readable by phone for auth" ON public.users;
DROP POLICY IF EXISTS "Users insertable by anon" ON public.users;
...
DROP POLICY IF EXISTS "Profiles insertable by anon" ON public.user_profiles;
...
DROP POLICY IF EXISTS "Ads insertable by authenticated" ON public.ads;
DROP POLICY IF EXISTS "Ads updatable by owner" ON public.ads;
DROP POLICY IF EXISTS "Ads deletable by owner" ON public.ads;
...
DROP POLICY IF EXISTS "Participants viewable by participants" ON public.conversation_participants;
DROP POLICY IF EXISTS "Participants insertable by authenticated" ON public.conversation_participants;
...
DROP POLICY IF EXISTS "Victories insertable by authenticated" ON public.victories;
DROP POLICY IF EXISTS "Victories updatable by owner" ON public.victories;
DROP POLICY IF EXISTS "Victories deletable by owner" ON public.victories;
...
DROP POLICY IF EXISTS "Event participants insertable by authenticated" ON public.event_participants;
DROP POLICY IF EXISTS "Notifications viewable by owner" ON public.notifications;
DROP POLICY IF EXISTS "Notifications insertable by system" ON public.notifications;
...
-- ============================================
-- RECÉRATION COMPLÈTE DE LA BASE DE DONNÉES
-- ============================================
...
-- ============================================
-- FIN DU SCRIPT DE NETTOYAGE ET RECÉATION
-- ============================================
-- Après exécution, votre base TennisMatch est propre et fonctionnelle.
