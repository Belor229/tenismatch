-- ============================================
-- TennisMatch - Script SQL pour authentification par téléphone uniquement
-- ============================================
-- Ce script supprime les tables existantes et recrée une structure optimisée
-- pour l'authentification par numéro de téléphone adaptée à chaque pays
...
-- ============================================
-- 2. TABLE users (authentification par téléphone uniquement)
-- ============================================
...
-- ============================================
-- 6. TABLE conversation_participants
-- ============================================
...
-- ============================================
-- 8. TABLE victories (publications)
-- ============================================
...
-- ============================================
-- 14. FONCTION pour mettre à jour last_message_at
-- ============================================
...
-- ============================================
-- 15. FONCTION pour mettre à jour current_participants
-- ============================================
...
-- ============================================
-- 16. VUES pour faciliter les requêtes
-- ============================================
...
-- FIN DU SCRIPT
-- ============================================
-- Après exécution, votre base TennisMatch est prête pour l'authentification par téléphone.
